...
export const suratKeteranganDomisili: TemplateConfig = {
    id: 'surat-keterangan-domisili',
    name: 'Surat Keterangan Domisili',
    category: 'keterangan',
    icon: '📜',
    description: 'Surat keterangan tempat tinggal dari kelurahan/desa',
    needsLetterhead: true,
    fields: [
        { id: 'nomorSurat', label: 'Nomor Surat', type: 'text', required: true, placeholder: '001/SKD/III/2026' },
        ...
        { id: 'statusKawin', label: 'Status Perkawinan', type: 'dropdown', required: true, options: ['Belum Kawin', 'Kawin', 'Cerai Hidup', 'Cerai Mati'] },
        { id: 'pekerjaan', label: 'Pekerjaan', type: 'text', required: true, placeholder: 'Wiraswasta' },
        { id: 'kewarganegaraan', label: 'Kewarganegaraan', type: 'text', required: true, placeholder: 'Indonesia', defaultValue: 'Indonesia' },
        { id: 'alamat', label: 'Alamat', type: 'textarea', required: true, placeholder: 'Jl. Melati No. 5, RT 03/RW 02' },
        { id: 'keperluan', label: 'Keperluan', type: 'text', required: true, placeholder: 'Mengurus KTP / Keperluan Bank' },
        ...
        return `
            <div class="letter-page">
                ...
                <div style="text-align:center;margin:24px 0;">
                    <p style="font-size:14px;font-weight:700;text-decoration:underline;letter-spacing:1px;margin-bottom:4px;">SURAT KETERANGAN DOMISILI</p>
                ...
                <div class="letter-body" style="line-height:1.8;">
                    ...
                    <table class="letter-data-table" style="margin:8px 0 8px 40px;">
                        ...
                        ${data.nip ? `<tr><td>NIP</td><td>: ${data.nip}</td></tr>` : ''}
                    </table>
                    ...
                    <table class="letter-data-table" style="margin:8px 0 8px 40px;">
                        ...
                        <tr><td>Status Perkawinan</td><td>: ${data.statusKawin || '...'}</td></tr>
                        <tr><td>Pekerjaan</td><td>: ${data.pekerjaan || '...'}</td></tr>
                        <tr><td>Kewarganegaraan</td><td>: ${data.kewarganegaraan || 'Indonesia'}</td></tr>
                        <tr><td>Alamat</td><td>: ${data.alamat || '...'}</td></tr>
                    </table>

                    <p style="text-indent:40px;margin-top:12px;">
                        Adalah benar orang tersebut di atas berdomisili di alamat sebagaimana tersebut 
